...
void GameManager:: Title() // 바퀴 움직이는거 추가 필요
{
	TCHAR str[128];
...
void GameManager::MapRender()
{
	...
	m_Enemy.EnemyIconRender(m_backbufferDC, m_ClientRect.right*0.9, m_ClientRect.bottom*0.1);

	m_Map->Render(m_backbufferDC,15,40);
